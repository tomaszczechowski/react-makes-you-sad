...
If React makes you sad and you are learning by copying from the boilerplate projects, read <a href="https://github.com/petehunt/webpack-howto" target="_blank">Pete Hunt's react-howto guide</a>.
...
If you are using a JavaScript bundler and you are not working on a production app, copy <a href="https://github.com/jarsbe/react-simple" target="_blank">jarsbe/react-simple</a> and start hacking with no build step.
